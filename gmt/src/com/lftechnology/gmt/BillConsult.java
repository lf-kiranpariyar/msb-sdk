...
@XmlRootElement(name = "BillConsult")
public class BillConsult {
    ...
    @XmlElementRef(name = "billerId", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> billerId;
    @XmlElementRef(name = "account", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
