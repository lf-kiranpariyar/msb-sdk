 ...
 *         &lt;element name="rem_edo" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlRootElement(name = "GetReceiptData")
public class GetReceiptData {
    ...
    @XmlElementRef(name = "rem_edo", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> remEdo;
    @XmlElementRef(name = "pais", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    ...
    /**
     * Gets the value of the remEdo property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getRemEdo() {
        return remEdo;
    }

    /**
     * Sets the value of the remEdo property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setRemEdo(JAXBElement<String> value) {
        this.remEdo = value;
    }
