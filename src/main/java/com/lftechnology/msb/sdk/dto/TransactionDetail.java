...
public class TransactionDetail {
    ...
    private String senderIdIsuueDate;
    ...
    public String getSenderIdIsuueDate() {
        return senderIdIsuueDate;
    }

    public void setSenderIdIsuueDate(String senderIdIsuueDate) {
        this.senderIdIsuueDate = senderIdIsuueDate;
    }
    ...
    @Override public String toString() {
        final StringBuffer sb = new StringBuffer("TransactionDetail{");
