...
public class TransactionApiTest {
    ...
    public void checkTransaction(){
        ...
        transactionRequestDTO = new TransactionRequestDTO("a6c3055c-bbed-11e8-a355-529269fb1437", null,2,"peter@peterojo.com",
                " ","Peter","Ojo","USA","raskin@gmail.com", "","Raskin","Maharjan",
                "Nigeria","USD",new BigDecimal(0.28),new BigDecimal(101.95),new BigDecimal(0.28),new BigDecimal(101.95),"2173986879","PETER   OJO","000015");
